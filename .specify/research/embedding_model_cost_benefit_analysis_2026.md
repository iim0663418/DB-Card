...
| 排名 | 模型 | 準確度 | 價格 ($/1M tokens) | 性價比分數 | 維度 | 多語言 |
|------|------|--------|-------------------|-----------|------|--------|
...
- **準確度**: 39.2% (倒數第二)
- **價格**: $0.13/1M tokens
- **問題**: Matryoshka 學習導致細節損失
- **現象**: 高相關性 (48.6%) 但低準確度 (39.2%) - "相關性陷阱"
...
### 1. 維度選擇
- **768 (Gemini)**: 平衡選擇
- **512 (Voyage Lite)**: 成本優化，語義略損
- **1024 (Mistral/Voyage 4)**: 最豐富語義
...
**報告日期**: 2026-02-26  
**當前模型**: Google Gemini Embedding 001  
**建議優先級**: 中 (非緊急，但值得評估)
